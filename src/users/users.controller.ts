...
export class UsersController {
  ...
  @Post("/signup")
  async singup(@Body() input: CreateUserDto, @Session() session: any): Promise<UserDto> {
  ...
  @Post("/login")
  async login(@Body() { email, password }: LoginDto, @Session() session: any): Promise<UserDto> {
  ...
  @Patch("/:id")
  async update(@Param("id") id: string, @Body() body: UpdateUserDto): Promise<UserDto> {
